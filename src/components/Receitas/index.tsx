  ...
  return (
    <section className="w-full h-full flex items-center justify-center flex-col  py-12 " id="receitas">
      ...
      <div className="grid grid-cols-3 w-11/12 h-full justify-center items-center gap-2 alter:flex flex-col">
        <div className="w-full h-full flex items-center flex-col rounded-md gap-4 py-4 bg-[#002233]">
          <div className="w-full h-80">
            <img src="assets/moranga.webp" alt="Moranga" className="imgGlobalCss" />
          </div>
          <div className="text-center text-xl text-white">
            <h3 className="text-white text-center top-6 font-bold text-xl">CAMARÃO NA MORANGA</h3>
          </div>
        ...
        <div className="w-full h-full  flex items-center flex-col rounded-md gap-4 py-4 bg-[#002233]">
          ...
          <div className="text-center text-xl text-white">
            <h3 className="text-white text-center top-6 font-bold text-xl">SALMÃO GRELHADO</h3>
          </div>
          <div className="w-full flex items-center justify-center">
           <button className="btnClassReceita">CONFIRA</button>
          </div>
        ...
        <div className="w-full h-full flex items-center flex-col rounded-md gap-4 py-4 bg-[#002233]">
          ...
          <div className="text-center text-xl text-white">
            <h3 className="text-white text-center top-6 font-bold text-xl">TAINHA ASSADA</h3>
          </div>
          <div className="w-full flex items-center justify-center">
           <button className="btnClassReceita">CONFIRA</button>
          </div>
